...
class core_course_renderer extends plugin_renderer_base {
     ...
     * @return string
     */
    protected function course_overview_files(coursecat_helper $chelper, core_course_list_element $course): string {
        global $CFG;

        $contentimages = $contentfiles = '';
        foreach ($course->get_course_overviewfiles() as $file) {
            $coursename = $chelper->get_course_formatted_name($course);
            $coursenamelink = new moodle_url('/course/view.php', ['id' => $course->id]);
            // $coursename, ['class' => $course->visible ? 'aalink' : 'aalink dimmed']);
            ...
            if ($isimage) {
                $contentimages .= html_writer::link($coursenamelink, html_writer::tag('div',
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $content .= $this->course_overview_files($chelper,$course);
