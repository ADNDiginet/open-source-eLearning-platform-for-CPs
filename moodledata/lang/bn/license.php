...
/**
 * Strings for component 'license', language 'bn', version '3.11'.
 *
 * @package     license
 * @category    string
...
$string['allrightsreserved'] = 'সকল অধিকার সংরক্ষিত';
$string['cc'] = 'Creative Commons';
$string['cc-nc'] = 'Creative Commons - বাণিজ্যিক নয়';
...
$string['public'] = 'পাবলিক ডোমেইন';
$string['unknown'] = 'অন্যান্য';
