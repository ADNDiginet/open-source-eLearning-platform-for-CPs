...
?>
    ...
    <script type="module" src="/theme/shared_assets/model-viewer.min.js"></script>
    <!-- <script src="/theme/shared_assets/focus-visible.js" defer=""></script> -->

    <link type="text/css" href="/theme/shared_assets/ASTHA_NEW_FILES/Ear_Final_01/styles.css" rel="stylesheet" />
    <?php
