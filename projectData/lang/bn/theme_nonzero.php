...
/**
 * Strings for component 'theme_nonzero', language 'bn', version '3.11'.
 *
...
$string['configtitle'] = 'Nonzero সেটিং';
$string['customcss'] = 'স্বনির্ধারিত CSS';
$string['customcssdesc'] = 'এখানে যে কোন CSS দিলে তা প্রত্যেক পৃষ্ঠায় সহজেই থীমটি স্বনির্ধারণের অনুমতি দেয়।';
$string['pluginname'] = 'Nonzero';
$string['region-side-post'] = 'ডান';
$string['region-side-pre'] = 'বাম';
$string['regionpostwidth'] = 'ডান কলামের প্রস্থ';
$string['regionpostwidthdesc'] = 'এটি  ডান কলামে সংগঠিত ব্লক অঞ্চলের প্রস্থ নির্ধারন করে।';
$string['regionprewidth'] = 'বাম কলামের প্রস্থ';
$string['regionprewidthdesc'] = 'এটি  বাম কলামে সংগঠিত ব্লক অঞ্চলের প্রস্থ নির্ধারন করে। ব্লগ বহির্বিন্যাস ব্যবহারের সময় কলামটি পৃষ্ঠার মাঝখানে প্রদর্শিত হয়';
